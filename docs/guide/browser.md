...
| --- | ---: | ---: | ---: |
| `@alexify/wrpc` — browser | 30.4 KB | **10.4 KB** | 11 KB |
| `@alexify/wrpc/sse` — browser | 33.1 KB | **11.4 KB** | 12 KB |
| `@alexify/wrpc/query` | 2.4 KB | **1.0 KB** | 2 KB |
| `@alexify/wrpc` — node | 119.0 KB | 39.5 KB | — |
